...
| **ScoreNote** | One expected score event with a Pitch, NoteValue, onset, Staff, tie-to-next flag, beam state, and optional imported stem direction, fingering, accidental, and fermata notation. Chord members share an onset. | Measured player timing, audio handles, rendering coordinates, and computed fallback notation geometry. |
