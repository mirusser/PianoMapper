...
- MusicXML `<direction>`-level octave shifts in both directions and all standard sizes (8va/8vb, 15ma/15mb, and 22a/22b), rendered on imported scores as a dashed bracket with an `8`, `15`, or `22` numeral while playback and grading use the sounding pitch.
